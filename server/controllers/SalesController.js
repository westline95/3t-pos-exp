...
const insertSales = async (req, res) => {
    const { salesDate, salesDue, custID, custName, custType, salesData, status, source, 
        discount, grandTotal, note, totalPayment, remainingPayment, totalSales, paymentMethod } = req.body;
    try{
