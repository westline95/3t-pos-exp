...
var Portal = React3.memo(function(inProps) {
  ...
  var _React$useState = React3.useState(props.visible && DomHandler.isClient()), _React$useState2 = _slicedToArray3(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  useMountEffect(function() {
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react5.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
var TimesIcon = React9.memo(React9.forwardRef(function(inProps, ref) {
...
//# sourceMappingURL=chunk-IBMSLGPD.js.map
